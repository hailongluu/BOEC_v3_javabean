...
INSERT INTO `accountcustomer` VALUES (1,'hailongluu','1'),(2,'nmh','1'),(3,'hap','1'),(4,'nva','3'),(5,'ndn','1');
...
INSERT INTO `addresscustomer` VALUES (1,'Hanoi','Hoang Mai','Dinh Cong'),(2,'Hanoi','Vinh Tuy','Vinh Tuy'),(3,'Hanoi','Ha Dong','Nguyen Trai'),(4,'Hanoi','Ha Dong','Nguyen Trai'),(5,NULL,NULL,'Hanoi');
...
CREATE TABLE `bill` (
  ...
  CONSTRAINT `bill order` FOREIGN KEY (`ID`) REFERENCES `order1` (`Id`)
...
INSERT INTO `bill` VALUES (1,2,'fast','cash','longluu','hanoi','hn','1111'),(2,2,'fast','cash','ha','danang','adsfasdf','Ã¡');
...
INSERT INTO `cart` VALUES (1,230000),(2,223000);
...
CREATE TABLE `cart_product` (
  ...
  PRIMARY KEY (`ID`),
  KEY `cart - cart_idx` (`CartID`),
  KEY `cart - product` (`ProductId`),
  CONSTRAINT `cart - cart` FOREIGN KEY (`CartID`) REFERENCES `cart` (`ID`),
  CONSTRAINT `cart - product` FOREIGN KEY (`ProductId`) REFERENCES `product` (`Id`)
...
INSERT INTO `cart_product` VALUES (104,1,'B0002',1),(105,2,'B0004',1);
...
INSERT INTO `customer` VALUES (1,1,1,1,'123456','1234567','hailongluu@gmail.com'),(2,2,2,2,NULL,'1000',NULL),(3,3,3,3,NULL,'0000',NULL),(4,4,4,4,NULL,'8888',NULL),(5,5,5,5,NULL,'00000',NULL);
...
CREATE TABLE `employee` (
  ...
  `Email` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `em - acc_idx` (`Account`),
  KEY `em - name_idx` (`Name`),
  KEY `em - add_idx` (`Address`),
  CONSTRAINT `em - acc` FOREIGN KEY (`Account`) REFERENCES `accountemployee` (`ID`),
  CONSTRAINT `em - add` FOREIGN KEY (`Address`) REFERENCES `addressemployee` (`ID`),
  CONSTRAINT `em - name` FOREIGN KEY (`Name`) REFERENCES `fullnameemployee` (`ID`)
...
INSERT INTO `employee` VALUES (1,NULL,NULL,NULL,NULL,NULL,NULL),(2,NULL,NULL,NULL,NULL,NULL,NULL),(3,NULL,NULL,NULL,NULL,NULL,NULL),(4,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `fullnamecustomer` VALUES (1,'Luu Hai',NULL,'Long'),(2,'Nguyen Minh',NULL,'Hieu'),(3,'Pham Hoang',NULL,'Anh'),(4,'Nguyen Viet',NULL,'Anh'),(5,'Nguyen Duc',NULL,'Nam');
...
CREATE TABLE `order1` (
  ...
  CONSTRAINT `order - cart ` FOREIGN KEY (`Id`) REFERENCES `cart` (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `order1` VALUES (1,1,1,NULL,'2019-05-16','Confirmed','Packaged','hn'),(2,1,3,NULL,'2019-05-16','Confirmed','Packaged','adsfasdf');
...
INSERT INTO `seller` VALUES (1,'seller');
...
INSERT INTO `shipper` VALUES (2,'shipper');
...
-- Dump completed on 2019-05-16  1:52:24
