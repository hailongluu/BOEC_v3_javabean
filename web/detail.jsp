...
<html lang="en">
                ...
                <div class="col-sm-10 col-md-4 offset-md-1">
                    ...
                    <a id="buyLink" onclick="btnAddClick()" class="btn btn-lg btn-danger"
                       style="padding:15px;color:white;text-decoration:none;">
                        ADD TO CART for only 50$ until 28th November 2019<br>
                        <span style="text-decoration:line-through;"> <%=product.getPrice()%> VND</span>
                        | 50% discount
                    </a>
    ...
    <script>
                    ...
                    function btnAddClick() {
                        ...
                        var is_login = <%=(String)session.getAttribute("isLogin")%>;
                        if (is_login === null)
                            window.location = "http://localhost:8080/boecdemov3/login.jsp";
                        else {
                            var new_url = "http://localhost:8080/boecdemov3/detailAdded?id=" + "<%=product.getId()%>";
