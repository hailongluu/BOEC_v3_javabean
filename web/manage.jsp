                            ...
                            <table class="table table-filter">
                                    ...
                                    <td>
                                        <div class="media">
                                            <a href="#" class="pull-left">
                                                <img src="img/books/vnbook/1.jpg" class="media-photo">
                                            </a>
                                            <div class="media-body">
                                                ...
                                                <br>
                                                <p class="summary">
                                                    <b>PRICE:</b> 250.000<br>
                                                    <b>QUANTITY:</b> 10<br><br>
                                ...
                                <tr data-status="Delivering">
                                    ...
                                    <td>
                                        <div class="media">
                                            <a href="#" class="pull-left">
                                                <img src="img/books/vnbook/2.jpg" class="media-photo">
                                            </a>
                                            <div class="media-body">
                                                <span class="media-meta pull-right">Febrero 13, 2016</span>
                                                <h4 class="title">
                                ...
                                <tr data-status="Cancelled">
                                    ...
                                    <td>
                                        <div class="media">
                                            <a href="#" class="pull-left">
                                                <img src="img/books/vnbook/3.jpg" class="media-photo">
                                            </a>
                                            <div class="media-body">
                                                <span class="media-meta pull-right">Febrero 13, 2016</span>
                                                <h4 class="title">
