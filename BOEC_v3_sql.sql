...
CREATE TABLE `accountcustomer` (
  ...
  PRIMARY KEY (`ID`),
  KEY `FKAccountCus151358` (`CustomerID`),
  CONSTRAINT `FKAccountCus151358` FOREIGN KEY (`CustomerID`) REFERENCES `customer` (`ID`)
...
INSERT INTO `accountcustomer` VALUES (1,1,'hailongluu','1');
...
CREATE TABLE `addresscustomer` (
  ...
  PRIMARY KEY (`ID`),
  KEY `FKAddressCus774592` (`CustomerID`),
  CONSTRAINT `FKAddressCus774592` FOREIGN KEY (`CustomerID`) REFERENCES `customer` (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `addresscustomer` VALUES (1,1,'Hanoi','Hoang Mai','Dinh Cong');
...
INSERT INTO `book` VALUES ('Michael Bungay Stanier','B0001','Bussiness',285,NULL),('Hilary Davidson','B0002','Psychological',450,NULL),('Suzy Krause','B0003','Humor',211,NULL),('Natasha Scripture','B0004','Travel',234,NULL);
...
CREATE TABLE `fullnamecustomer` (
  ...
  PRIMARY KEY (`ID`),
  KEY `FKFullNameCu145702` (`CustomerID`),
  CONSTRAINT `FKFullNameCu145702` FOREIGN KEY (`CustomerID`) REFERENCES `customer` (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `fullnamecustomer` VALUES (1,1,'Luu','Hai','Long');
...
INSERT INTO `product` VALUES ('B0001','',8,100,'/img/book/book1.jpg','The Coaching Habit: Say Less, Ask More & Change the Way You Lead Forever'),('B0002',NULL,5,100,'/img/book/book2','One Small Sacrifice (Shadows of New York Book 1)'),('B0003',NULL,10,100,'/img/book/book3.jpg','Valencia and Valentine'),('B0004',NULL,9,100,'/img/book/book4.jpg','Man Fast: A Memoir');
...
-- Dump completed on 2019-05-14 19:37:44
