...
@NamedQueries({
    ...
    , @NamedQuery(name = "Desktop.findByProductIdproduct", query = "SELECT d FROM Desktop d WHERE d.productIdproduct = :productIdproduct")})
public class Desktop implements Serializable {
    ...
    public Desktop(String productIdproduct) {
    ...
    public String toString() {
        return "entities.Desktop[ productIdproduct=" + productIdproduct + " ]";
    }
