...
@NamedQueries({
    ...
    , @NamedQuery(name = "Smartphone.findByProductIdproduct", query = "SELECT s FROM Smartphone s WHERE s.productIdproduct = :productIdproduct")})
public class Smartphone implements Serializable {
    ...
    public Smartphone(String productIdproduct) {
    ...
    public String toString() {
        return "entities.Smartphone[ productIdproduct=" + productIdproduct + " ]";
    }
