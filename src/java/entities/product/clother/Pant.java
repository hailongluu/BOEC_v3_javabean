...
@NamedQueries({
    ...
    , @NamedQuery(name = "Pant.findByProductIdproduct", query = "SELECT p FROM Pant p WHERE p.productIdproduct = :productIdproduct")
    , @NamedQuery(name = "Pant.findByParnSpecification", query = "SELECT p FROM Pant p WHERE p.parnSpecification = :parnSpecification")})
public class Pant implements Serializable {

    @Size(max = 255)
    @Column(name = "ParnSpecification")
    private String parnSpecification;
    ...
    public Pant(String productIdproduct) {
    ...
    public String toString() {
        return "entities.Pant[ productIdproduct=" + productIdproduct + " ]";
    }

    public String getParnSpecification() {
        return parnSpecification;
    }

    public void setParnSpecification(String parnSpecification) {
        this.parnSpecification = parnSpecification;
    }
